...
%build
EXTENSION_DIR=%{_datadir}/php7/modules; export EXTENSION_DIR
...
--with-mcrypt  --with-mysqli=mysqlnd --with-pdo-mysql=mysqlnd \
--with-pdo-sqlite --with-tidy --with-pear=%{_datadir}/php7/pear --disable-debug \
--prefix=%{_datadir}/php7 --with-config-file-path=%{_sysconfdir}/php7 --with-apxs2=%{_bindir}/apxs \
--with-config-file-scan-dir=%{_sysconfdir}/php7.d \
